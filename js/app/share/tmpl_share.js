...
define ([], function () {
    ...
    '<div id="moban" class="gloab_box">',
        ...
        '<div id="mySelfDiv" class="footer" style="display: none;">',
            '<a class="" href="javaScript:;" style="width:33%;" data-router="tmplist"><span class="footer_a"><i class="iconfont icon-cf-c07"></i>继续创建</span></a>',
            '<a  class="" href="javaScript:;" style="width:33%;" data-router="musiclist"><span class="footer_b"><i class="iconfont icon-yinle"></i>我的相册</span></a>',
            '<a  class=" share_menu_js" href="javaScript:;" style="width:33%;" data-router="addnote"><span class="footer_c"><i class="iconfont icon-xiangpian"></i>分享相册</span></a>',
