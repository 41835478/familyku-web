...
//      图片加载完毕之后进行压缩，然后上传
    ...
    var uploadAjax = function (data){
        $.ajax({
            url: URL.baseURLForward1 + 'api/images/uploadBase64',
            type:"post",
            // secureuri: false,
            // fileElementId: 'addImg',
            data: {apikey:'flzxsqcysyhljt',prefix:'jiajiaku',file:data},
            //dataType: 'json',
            success: function(data, status){
                if(data.code==Final.RESPONSE_STATUS.success){
